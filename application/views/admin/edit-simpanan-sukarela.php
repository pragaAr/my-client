        ...
        <div class="card card-info">
          <div class="card-body">
            <form action="" method="post">
              <input type="hidden" name="id_sukarela" value="<?= $data['id_sukarela']; ?>">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nominal_sukarela" class="form-control" id="nominal_sukarela" value="<?= $data['nominal_sukarela']; ?>">
