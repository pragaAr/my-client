<div class="main-content">
  <section class="section">
    ...
    <div class="card">
      <div class="card-body">
        <a href="<?= base_url('simpanan_wajib') ?>" class="btn btn-primary mb-2" data-toggle="modal" data-target="#addSimpananWajib">Tambah Data</a>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      ...
                      <a href="<?= base_url('simpanan_wajib/delete/') . $si['id_sim_wajib']; ?>" class="btn btn-danger btn-sm tombol-hapus" data-toggle="tooltip" title="Delete"><i class="fas fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
                <?php $i++; ?>
...
<div class="modal fade" id="addSimpananWajib" tabindex="-1" role="dialog" aria-labelledby="addSimpananWajib" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addSimpananWajib">Tambah Data Baru</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?= base_url('simpanan_wajib'); ?>" method="post">
